...
<h1 class="page-header">
    ...
    <div class="pull-right">
        <a href="{{ route('admin.taxonomy.index') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-tags"></i> Taxonomy</a>
        <a href="{{ route('admin.taxons.create') }}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-plus"></i> Create Taxon</a>
    </div>
</h1>
